...
def build_parser() -> argparse.ArgumentParser:
    ...
    comp.add_argument('--rff_hopdc_feature_mode', type=str, default='cos_positive', choices=['sincos', 'cos', 'cos_positive', 'elu'], help='Random feature map for RFF-HopDC. cos_positive is the stable default; sincos matches the legacy RFF attention feature map.')
